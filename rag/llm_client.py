"""
Unified LLM Client for RAG operations
...
class UnifiedLLMClient:
    ...
    def generate_response(self, prompt: str, max_tokens: int = 500, temperature: float = 0.1, context: str = None) -> str:
        ...
        try:
            ...
            # Only show detailed generation info in verbose mode
            if context:
                console.print(Text("[OK]", style="bold green"), f"Generated response for {context} in {elapsed:.2f}s via {self.active_provider}")
            else:
